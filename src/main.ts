...
const listEl = document.getElementById("player-list") as HTMLDivElement;
const emptyStateEl = document.getElementById("empty-state") as HTMLDivElement;
const countEl = document.getElementById("player-count") as HTMLSpanElement;
const searchInput = document.getElementById("search-input") as HTMLInputElement;

const form = document.getElementById("add-form") as HTMLFormElement;
const nameInput = document.getElementById("name-input") as HTMLInputElement;
const sportInput = document.getElementById("sport-input") as HTMLInputElement;
...
function findPlayer(id: number): Player | undefined {
...
function buildPlayerView(player: Player): DocumentFragment {
...
function buildEditForm(player: Player): HTMLDivElement {
